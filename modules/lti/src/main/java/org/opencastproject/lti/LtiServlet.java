...
public class LtiServlet extends HttpServlet implements ManagedService {
  ...
  private static final String LTI_CUSTOM_TOOL = BasicLTIConstants.CUSTOM_PREFIX + "tool";
  private static final String LTI_CUSTOM_DL_TOOL = BasicLTIConstants.CUSTOM_PREFIX + "dl_tool";
  private static final String LTI_CUSTOM_TEST = BasicLTIConstants.CUSTOM_PREFIX + "test";
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    for (Object k : req.getParameterMap().keySet()) {
      ...
      if (key.startsWith(BasicLTIConstants.CUSTOM_PREFIX) && (!LTI_CUSTOM_TOOL.equals(key))
            && !LTI_CUSTOM_DL_TOOL.equals(key)) {
        ...
        logger.debug("LTIPREFIX: Found custom var: {}:{}", paramName, paramValue);
